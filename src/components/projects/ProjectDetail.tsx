        ...
        <div className="container p-4" style={{ paddingBottom: '200px' }}>
            <div className="row shadow p-2 rounded ">
                <div className="col-12 text-danger mt-1">
                    <h4><Link className="text-danger" to="/">Home</Link> | <Link className="text-danger" to="/projects">Projects</Link> | {product.title} </h4>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-7 my-2">
                        <div className="row p-md-4 p-2">
                            ...
                            {
                                mainImage != null ?
                                    <div className="col-md-12 p-0 border border-dark-2" >
                            ...
                            <div className="col-md-12 my-2">
                                <div className="row">
                                    {
                                        product.image1 ?
                                            <div className="col-md-2 col-3 border p-md-2 p-1 d-flex justify-center align-items-center  "
                    ...
                    <div className="col-md-5">
                        <div className="row  p-md-4 p-2">
                            <h1 className="fw-bold" style={{ fontSize: "4.5vw" }}>{product.title}</h1>
                        ...
                        <div className="row  p-md-4 p-2">
                            {
                                youtubeEmbed != null
                                    ?
                                    <div className="col-12 p-3 my-5 border text-center ">
                                        <h1 className='fw-bold pb-3'>Project Video</h1>
